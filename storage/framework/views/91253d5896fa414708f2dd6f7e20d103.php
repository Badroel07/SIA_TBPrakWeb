...
<body class="bg-slate-100 font-sans text-slate-900 h-screen overflow-hidden flex" <?php echo $__env->yieldContent('bodyAttributes'); ?>>
    ...
    <aside class="w-72 bg-white m-4 rounded-3xl shadow-xl flex flex-col shrink-0 relative overflow-hidden">
        ...
        <div class="p-8 flex items-center gap-3">
            <div class="w-10 h-10 flex items-center justify-center bg-[#6200EA] text-white rounded-xl shadow-[#6200EA]/30 shadow-lg">
        ...
        <nav class="flex-1 px-4 space-y-3 overflow-y-auto py-4">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>" 
               class="flex items-center gap-4 px-4 py-4 rounded-2xl transition-all duration-300 group font-display <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-[#6200EA] text-white shadow-lg shadow-[#6200EA]/30 translate-x-1' : 'text-slate-500 hover:bg-slate-50 hover:text-[#6200EA] hover:translate-x-1'); ?>">
            ...
            <a href="<?php echo e(route('admin.medicines.index')); ?>" 
               class="flex items-center gap-4 px-4 py-4 rounded-2xl transition-all duration-300 group font-display <?php echo e(request()->routeIs('admin.medicines.*') ? 'bg-[#6200EA] text-white shadow-lg shadow-[#6200EA]/30 translate-x-1' : 'text-slate-500 hover:bg-slate-50 hover:text-[#6200EA] hover:translate-x-1'); ?>">
            ...
            <a href="<?php echo e(route('admin.orders.index')); ?>" 
               class="flex items-center gap-4 px-4 py-4 rounded-2xl transition-all duration-300 group font-display <?php echo e(request()->routeIs('admin.orders.*') ? 'bg-[#6200EA] text-white shadow-lg shadow-[#6200EA]/30 translate-x-1' : 'text-slate-500 hover:bg-slate-50 hover:text-[#6200EA] hover:translate-x-1'); ?>">
            ...
            <a href="<?php echo e(route('admin.users.index')); ?>" 
               class="flex items-center gap-4 px-4 py-4 rounded-2xl transition-all duration-300 group font-display <?php echo e(request()->routeIs('admin.users.*') ? 'bg-[#6200EA] text-white shadow-lg shadow-[#6200EA]/30 translate-x-1' : 'text-slate-500 hover:bg-slate-50 hover:text-[#6200EA] hover:translate-x-1'); ?>">
        ...
        <div class="p-4 mt-auto">
            <div class="bg-slate-50 rounded-2xl p-4 border border-slate-100 flex items-center gap-3">
                <div class="w-10 h-10 rounded-full bg-[#6200EA]/20 text-[#6200EA] flex items-center justify-center font-bold text-sm">
