...
<?php $__env->startSection('content'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div
            ...
            <p class="text-2xl font-bold text-gray-800 mt-1">Rp <?php echo e($stats['totalRevenue']); ?></p>
        </div>
        ...
        <div
            ...
            <p class="text-2xl font-bold text-gray-800 mt-1"><?php echo e($stats['totalOrders']); ?></p>
        </div>
        ...
        <div
            ...
            <p class="text-2xl font-bold text-gray-800 mt-1"><?php echo e(count($lowStockMedicines)); ?></p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
            <div
                ...
                <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-[#6200EA] hover:text-purple-700 text-sm font-semibold flex items-center">
                    ...
                    <tbody class="divide-y divide-gray-100 text-sm">
                        <?php $__empty_1 = true; $__currentLoopData = $recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 font-medium text-gray-800"><?php echo e($order->invoice_number); ?></td>
                                <td class="px-6 py-4 text-gray-600 truncate max-w-[150px]">
                                    <?php echo e($order->details->first()?->medicine->name ?? 'Item Pesanan'); ?>

                                    <?php if($order->details->count() > 1): ?>
                                        <span class="text-xs text-gray-400"> +<?php echo e($order->details->count() - 1); ?> more</span>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4">
                                    <?php
                                    ...
                                    ?>
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium <?php echo e($statusClass); ?>">
        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="space-y-4">
                    <?php $__empty_1 = true; $__currentLoopData = $popularMedicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                            $icon = 'medication';
                        ...
                        <div
                            ...
                            <div
                                ...
                                <span
                                    class="material-icons-round text-gray-400"><?php echo e($icon); ?></span>
                            </div>
                            <div class="flex-1">
                                <h4 class="text-sm font-semibold text-gray-800"><?php echo e($medicine->name); ?></h4>
                                <p class="text-xs text-gray-500"><?php echo e(ucfirst($medicine->category)); ?></p>
                            </div>
                            <div class="text-right">
                                <p class="text-sm font-bold text-gray-800"><?php echo e(number_format($medicine->total_sold ?? 0)); ?></p>
            ...
            ?>
            <div
                class="<?php echo e($alertBg); ?> rounded-xl shadow-lg p-6 text-white relative overflow-hidden">
                ...
                <?php if(count($lowStockMedicines) > 0): ?>
                    <p class="text-sm text-purple-100 mb-4 relative z-10">
                        Kamu memiliki <span class="font-bold text-white"><?php echo e(count($lowStockMedicines)); ?> obat</span> yang stoknya rendah. Segera restock!
                    </p>
                    <a href="<?php echo e(route('admin.medicines.index')); ?>"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SIA_TBPrakWeb\resources\views/admin/index.blade.php ENDPATH**/ ?>