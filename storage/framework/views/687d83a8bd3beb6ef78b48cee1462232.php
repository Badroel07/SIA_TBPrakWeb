...
<?php $__env->startSection('content'); ?>
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
            ...
            <p class="text-gray-500 mt-1">Create a new account for admin, cashier, or customer.</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
                <h3 class="text-lg font-bold text-gray-800 flex items-center gap-2">
                    <span class="material-icons-round text-[#6200EA]">person_add</span>
                    User Information
                </h3>
            </div>

            <form method="POST" action="<?php echo e(route('admin.users.store')); ?>" class="p-6 md:p-8 space-y-6">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <button type="button" onclick="togglePassword('password', 'eyeIconCreate')" class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#6200EA] transition-colors">
                                    <span id="eyeIconCreate" class="material-icons-round text-lg">visibility</span>
                                </button>
                            </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SIA_TBPrakWeb\resources\views/admin/users/create.blade.php ENDPATH**/ ?>