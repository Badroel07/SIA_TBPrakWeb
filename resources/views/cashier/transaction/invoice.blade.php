...
<head>
    ...
    <title>Faktur {{ $transaction->invoice_number }} - ePharma POS</title>
    ...
    <div class="invoice-container">
        ...
        <div class="invoice-info">
            <div>
                ...
                <div>{{ $transaction->transaction_date->format('d M Y, H:i') }}</div>
            </div>
            <div style="text-align: right;">
                <div>Kasir:</div>
                <div style="font-weight: 600; color: #1e293b;">{{ $transaction->user->name ?? 'N/A' }}</div>
            </div>
        </div>
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $detail->medicine->name ?? 'Item Dihapus' }}</td>
        ...
        <div class="summary">
            ...
            <div class="summary-row change">
                <span>Kembalian</span>
                <span>Rp {{ number_format(($transaction->cash_received ?? 0) - $transaction->total_amount, 0, ',', '.') }}</span>
            </div>
        </div>
        ...
        <div class="actions">
            ...
            <a href="{{ route('cashier.transaction.index') }}" class="btn btn-secondary">
                ← Kembali ke POS
            </a>
        </div>
    </div>
