@extends('cashier.layouts.app', ['activeMenu' => 'dashboard'])

@section('title', 'Dashboard - ePharma POS')
    ...
    <div class="w-full space-y-6">
            ...
            <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 flex flex-col justify-between h-32 relative overflow-hidden group">
                ...
                <div class="relative z-10 flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-slate-900">{{ $totalCustomers }}</h3>
                    </div>
            ...
            <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 flex flex-col justify-between h-32 relative overflow-hidden group">
                ...
                <div class="relative z-10 flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-red-600">{{ $lowStockItems }}</h3>
                    </div>
                    <div class="p-2 bg-red-100 text-red-600 rounded-lg">
                        <span class="material-symbols-outlined">inventory_2</span>
                    </div>
                </div>
                <a href="{{ route('cashier.transaction.index') }}" class="relative z-10 mt-auto text-xs text-blue-600 font-bold hover:underline">
                    Periksa Stok &rarr;
                </a>
            </div>
            ...
            <div class="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 flex flex-col justify-between h-32 relative overflow-hidden group">
                ...
                <div class="relative z-10 flex justify-between items-start">
                    <div>
                        ...
                        <h3 class="text-2xl font-bold text-purple-600">{{ $pendingOrders }}</h3>
                    </div>
                    <div class="p-2 bg-purple-100 text-purple-600 rounded-lg">
                        <span class="material-symbols-outlined">pending_actions</span>
                    </div>
                </div>
                <a href="{{ route('cashier.orders.incoming') }}" class="relative z-10 mt-auto text-xs text-blue-600 font-bold hover:underline">
                    Lihat Pesanan &rarr;
                </a>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="p-5 border-b border-slate-100 flex justify-between items-center">
                ...
                <a href="{{ route('cashier.transaction.history') }}" class="text-sm font-bold text-blue-600 hover:text-blue-700 transition-colors">
                    Lihat Semua
                </a>
            </div>
