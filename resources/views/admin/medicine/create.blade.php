{{-- Modal Create Obat - Material Design --}}
<div id="medicineModal"
    ...
    <div id="modalContent"
        ...
        <div class="overflow-y-auto p-6 bg-gray-50/50 flex-grow">
            <form id="createMedicineForm" action="{{ route('admin.medicines.store') }}" method="POST" enctype="multipart/form-data"
                class="space-y-6">
                @csrf
                ...
                <div
                    class="bg-white p-5 rounded-xl border border-[#6200EA]/20 shadow-sm relative overflow-hidden group hover:shadow-md transition-shadow">
                    <div class="absolute top-0 left-0 w-1 h-full bg-[#6200EA]"></div>
                    <h4
                        class="text-sm font-bold text-gray-900 mb-5 flex items-center gap-2 border-b border-gray-100 pb-3">
                        <span
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="group">
                            ...
                            <textarea name="description" rows="2"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-800 focus:bg-white focus:border-[#6200EA] focus:ring-4 focus:ring-[#6200EA]/10 transition-all outline-none resize-none"
                        ...
                        <div class="group">
                            ...
                            <textarea name="full_indication" rows="3"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-800 focus:bg-white focus:border-[#6200EA] focus:ring-4 focus:ring-[#6200EA]/10 transition-all outline-none resize-none"></textarea>
                        </div>
