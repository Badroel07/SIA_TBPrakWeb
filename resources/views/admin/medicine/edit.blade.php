    ...
    <div id="editModalContent"
        ...
        <div class="overflow-y-auto p-6 bg-gray-50/50 flex-grow">
            <form id="editMedicineForm" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="bg-blue-50/40 rounded-xl p-5 border border-blue-100 relative overflow-hidden group hover:shadow-md transition-shadow"
                    x-data="{ mode: 'adjust' }">
                    <div class="absolute top-0 left-0 w-1 h-full bg-blue-500"></div>
                    <div class="flex items-center justify-between mb-4 border-b border-blue-100 pb-3">
                        <h4 class="text-sm font-bold text-blue-900 flex items-center gap-2">
                            <span
                                class="w-8 h-8 rounded-lg text-blue-600 flex items-center justify-center text-lg material-icons-round">inventory_2</span>
                            Manajemen Stok
                        </h4>

                        <div class="bg-white rounded-lg p-1 flex shadow-sm border border-blue-200">
                            <button type="button"
                                ...
                                :class="mode === 'adjust' ? 'bg-blue-600 text-white shadow-sm' : 'text-gray-500 hover:bg-blue-50'">
                                Atur (+/-)
                            </button>
                            <button type="button"
                                @click="mode = 'manual'; document.getElementById('edit-stock-adjustment').value = ''"
                                class="px-3 py-1.5 text-xs font-bold rounded-md transition-all"
                                :class="mode === 'manual' ? 'bg-blue-600 text-white shadow-sm' : 'text-gray-500 hover:bg-blue-50'">
                                Stok Tetap
                            </button>
                        </div>
                    </div>
                    ...
                    <div x-show="mode === 'adjust'" class="animate-[fadeIn_0.2s_ease-out]">
                        <div class="relative">
                            <span class="absolute left-3.5 top-2.5 text-blue-500 font-bold text-sm">+/-</span>
                            <input type="number" name="stock_adjustment" id="edit-stock-adjustment"
                                placeholder="contoh: +10 (tambah), -5 (kurang)"
                                class="w-full pl-10 pr-4 py-2.5 bg-white border border-blue-200 rounded-xl text-sm text-gray-800 focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition-all outline-none font-medium">
                        </div>
                    ...
                    <div x-show="mode === 'manual'" class="animate-[fadeIn_0.2s_ease-out]" style="display: none;">
                        <input type="number" name="stock_manual" id="edit-stock-manual" min="0"
                            ...
                            class="w-full px-4 py-2.5 bg-white border border-purple-200 rounded-xl text-sm text-gray-800 focus:border-purple-500 focus:ring-4 focus:ring-purple-100 transition-all outline-none font-medium">
                        <p
                            class="text-xs text-purple-600 mt-2 flex items-center gap-1 font-medium bg-purple-50 p-2 rounded-lg inline-block">
